...
extern void REL_FLDoorRlsDriver(uint8 rtu_SI_e_Volt100mV, boolean
  ...
  *rty_SO_e_MotorPwm, boolean *rty_SO_b_Error, DW_FLDoorRlsDriver_REL_T *localDW);
extern void REL_FLDoorRlsReq_Init(boolean *rty_SO_b_DoorRlsReq, Unlock_Req_E
  *rty_SO_m_UnlockReq);
extern void REL_FLDoorRlsReq(UInt8 rtu_SI_e_EspVehSpd, Boolean
  ...
  *rty_SO_b_DoorRlsReq, DW_FLDoorRlsReq_REL_T *localDW);
