...
typedef struct {
  ...
  uint8_T is_SwValid_b;                /* '<S3>/RLDoorRlsReq' */
  uint8_T is_RlsReq_c;                 /* '<S3>/RLDoorRlsReq' */
  uint8_T is_Trigger_f;                /* '<S3>/RLDoorRlsReq' */
  uint8_T is_DoorLock_a;               /* '<S3>/RLDoorRlsReq' */
  uint8_T temporalCounter_i1_i;        /* '<S3>/RLDoorRlsReq' */
  ...
  uint8_T is_active_c5_DoorRlsReq_c;   /* '<S3>/FLDoorRlsReq' */
  uint8_T is_SwValid_e;                /* '<S3>/FLDoorRlsReq' */
  uint8_T is_RlsReq_p;                 /* '<S3>/FLDoorRlsReq' */
  uint8_T is_Trigger_n;                /* '<S3>/FLDoorRlsReq' */
  uint8_T is_DoorLock_g;               /* '<S3>/FLDoorRlsReq' */
  ...
  uint8_T temporalCounter_i1_g;        /* '<S3>/FLDoorRlsReq' */
  uint8_T temporalCounter_i2_b;        /* '<S3>/FLDoorRlsReq' */
  uint8_T temporalCounter_i3_g;        /* '<S3>/FLDoorRlsReq' */
  uint8_T temporalCounter_i4_c;        /* '<S3>/FLDoorRlsReq' */
  ...
  boolean_T SL_b_DoorHndBtnValid_g;    /* '<S3>/FLDoorRlsReq' */
  boolean_T SI_b_DoorInBtnSts_start_a; /* '<S3>/FLDoorRlsReq' */
  boolean_T SL_b_DoorInBtnValid_start_c;/* '<S3>/FLDoorRlsReq' */
  boolean_T SI_b_DoorHndBtnSts_start_l;/* '<S3>/FLDoorRlsReq' */
  boolean_T SL_b_DoorHndBtnValid_start_l;/* '<S3>/FLDoorRlsReq' */
